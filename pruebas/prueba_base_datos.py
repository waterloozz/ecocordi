...
ok(set(columnas(srv.db, "productos")) == {"id", "nombre", "descripcion", "imagen"},
...
ok(set(columnas(srv.db, "productos")) == {"id", "nombre", "descripcion", "imagen"}, "Columnas antiguas eliminadas")
